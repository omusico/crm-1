  <div class="wrapper-md">
    <div class="panel panel-default">
      ...
      <div>
        ...
        @else
            <h5 class="p-15 m-0">This client doesn't have any projects.</h5>
        @endif
        <div class="client-btns">
            <ul>
                <li><a href="{{ action('ProjectsController@create') . '?c=' . $client->id }}" class="btn btn-md btn-success">Create New Project</a></li>
            </ul>
        </div>
      </div>
    </div>
