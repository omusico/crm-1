          ...
          <div class="row row-sm text-center">
            ...
            <div class="col-xs-6">
              <a href class="block panel padder-v item">
                <span class="text-info font-thin h1 block">9</span>
                <span class="text-muted text-xs">New Support Tickets</span>
            ...
            <div class="col-xs-6">
              <a href class="block panel padder-v bg-primary item">
                ...
                <span class="text-muted text-xs">New Sales Leads</span>
                <span class="bottom text-right w-full">
                  <i class="fa fa-cloud-upload text-muted m-r-sm"></i>
                </span>
              </a>
            ...
            <div class="col-xs-6">
              <a href class="block panel padder-v bg-info item">
                <span class="text-white font-thin h1 block">3</span>
                <span class="text-muted text-xs">Open Projects</span>
            ...
            <div class="col-xs-6">
              <a href class="block panel padder-v item">
                <span class="text-info font-thin h1 block">7</span>
                <span class="text-muted text-xs">New Emails</span>
                <span class="top text-left">
                  <i class="fa fa-caret-up text-warning m-l-sm"></i>
                </span>
              </a>
            ...
            <ul class="list-group list-group-lg m-b-none">
              <li class="list-group-item">
                <a href class="thumb-sm m-r">
                  <img src="{{ url('img/a0.jpg') }}" class="r r-2x">
                </a>
          ...
          <ul class="list-group no-bg no-borders pull-in">
            <li class="list-group-item">
              <a herf class="pull-left thumb-sm avatar m-r">
                <img src="{{ url('img/a0.jpg') }}" alt="..." class="img-circle">
      ...
      <div class="tab-pane" id="chat">
        <div class="wrapper-md">
          ...
          <ul class="list-group no-borders pull-in auto">
            <li class="list-group-item">
              <span class="pull-left thumb-sm m-r"><img src="{{ url('img/a0.jpg') }}" alt="..." class="img-circle"></span>
